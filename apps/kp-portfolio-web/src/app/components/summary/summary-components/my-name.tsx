    ...
    <section className="flex flex-col items-center justify-center space-y-8 text-center md:py-32">
      <div className="flex flex-col items-center justify-center -2xl space-y-8 py-16 text-center md:py-24">
        <div className="space-y-4">
          <h2 className="title bg-gradient-to-br from-foreground from-30% via-foreground/90 to-foreground/70 bg-clip-text text-4xl font-bold tracking-tight text-transparent sm:text-5xl md:text-6xl lg:text-7xl">
